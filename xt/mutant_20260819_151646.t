...
# --- SURVIVOR: BOOL_NEGATE_523_2 (MEDIUM) line 523 in set() ---
# Source:  return _carp_set_usage() unless defined($lang);
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_523_2 line 523 in set()';
    # NOTE: new() called with no arguments as a starting point.
    # If Lingua::Text requires constructor arguments, add them here.
    my $obj = new_ok('Lingua::Text');
    # TODO: exercise line 523 in set() to detect the mutant
    fail('BOOL_NEGATE_523_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_530_2 (MEDIUM) line 530 in set() ---
# Source:  return _carp_set_usage() unless _is_valid_language($lang);
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_530_2 line 530 in set()';
    # NOTE: new() called with no arguments as a starting point.
    # If Lingua::Text requires constructor arguments, add them here.
    my $obj = new_ok('Lingua::Text');
    # TODO: exercise line 530 in set() to detect the mutant
    fail('BOOL_NEGATE_530_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_533_2 (MEDIUM) line 533 in set() ---
# Source:  return _carp_set_usage() unless defined($text);
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_533_2 line 533 in set()';
    # NOTE: new() called with no arguments as a starting point.
    # If Lingua::Text requires constructor arguments, add them here.
    my $obj = new_ok('Lingua::Text');
    # TODO: exercise line 533 in set() to detect the mutant
    fail('BOOL_NEGATE_533_2: replace with real assertion');
}
...
# --- LOW HINT: RETURN_UNDEF_523_2 line 523 in set() ---
# Source:  return _carp_set_usage() unless defined($lang);
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_530_2 line 530 in set() ---
# Source:  return _carp_set_usage() unless _is_valid_language($lang);
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# If Lingua::Text requires constructor arguments, add them here.
# my $obj = new_ok('Lingua::Text');
# ok($obj->..., 'RETURN_UNDEF_530_2: add assertion here');

# --- LOW HINT: RETURN_UNDEF_533_2 line 533 in set() ---
# Source:  return _carp_set_usage() unless defined($text);
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# If Lingua::Text requires constructor arguments, add them here.
# my $obj = new_ok('Lingua::Text');
# ok($obj->..., 'RETURN_UNDEF_533_2: add assertion here');
