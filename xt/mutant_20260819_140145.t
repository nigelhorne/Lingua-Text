...
# --- SURVIVOR: BOOL_NEGATE_302_2 (MEDIUM) line 302 in set() ---
# Source:  return _carp_set_usage() unless defined($lang);
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_302_2 line 302 in set()';
    # NOTE: new() called with no arguments as a starting point.
    # If Lingua::Text requires constructor arguments, add them here.
    my $obj = new_ok('Lingua::Text');
    # TODO: exercise line 302 in set() to detect the mutant
    fail('BOOL_NEGATE_302_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_305_2 (MEDIUM) line 305 in set() ---
# Source:  return _carp_set_usage() unless defined($text);
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_305_2 line 305 in set()';
    # NOTE: new() called with no arguments as a starting point.
    # If Lingua::Text requires constructor arguments, add them here.
    my $obj = new_ok('Lingua::Text');
    # TODO: exercise line 305 in set() to detect the mutant
    fail('BOOL_NEGATE_305_2: replace with real assertion');
}
...
# --- LOW HINT: RETURN_UNDEF_302_2 line 302 in set() ---
# Source:  return _carp_set_usage() unless defined($lang);
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# If Lingua::Text requires constructor arguments, add them here.
# my $obj = new_ok('Lingua::Text');
# ok($obj->..., 'RETURN_UNDEF_302_2: add assertion here');

# --- LOW HINT: RETURN_UNDEF_305_2 line 305 in set() ---
# Source:  return _carp_set_usage() unless defined($text);
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# If Lingua::Text requires constructor arguments, add them here.
# my $obj = new_ok('Lingua::Text');
# ok($obj->..., 'RETURN_UNDEF_305_2: add assertion here');
